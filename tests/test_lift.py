from pylift.lift import LiftDoc, LiftLevel, LiftFieldSpec, LiftVocabulary
import pytest
...
class TestLift():
    ...
    def test_get_frequencies_wo_subfield(self, caplog) -> None:
        """
    ...
    def test_get_frequencies_with_subfield(self) -> None:
        """
        Without the subfield arg, must return a dict {subflied -> collections.Counter}
        """
        lift: LiftDoc = LiftDoc("tests/data/tiny.lift")
    ...
    def test__test_singleton_inner_list(self) -> None:
        l1 = [["un"], ["deux"]]
    ...
    def test__test_missing_entry_id(self) -> None:
